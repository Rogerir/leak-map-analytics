...
def atualizar_painel(industry_selecionada, theme_clicks):
    ...
    card_usd_content = [
        html.P("MÉDIA SALARIAL ANUAL(Em Reais)",
               style={'margin': '0 0 8px 0', 'fontSize': '12px', 'fontWeight': '600', 'color': tema['text_muted']}),
    ...
    fig_matriz = px.scatter(
        ...
        color="Impacto_da_IA", size="Salario_Reais",
        ...
        labels={
            ...
            "Salario_Reais": "Salário Anual (R$)",
            "Impacto_da_IA": "Impacto da IA"
        }
    )
    ...
    fig_skills = px.bar(
        ...
        title="Ato 3: O que precisamos estudar hoje?", color_discrete_sequence=['#EC4899'],
