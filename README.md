...
*   **Dispersão:** Gráfico que cruza o "Risco da IA roubar a vaga" com o "Crescimento de Vagas", dimensionado pelo salário.
*   **Top Jobs:** Gráfico de barras horizontais destacando os 5 cargos com maior potencial de contratação futura.
*   **Habilidades:** Gráfico de barras mapeando as 5 habilidades técnicas mais exigidas pelas empresas.
...
*   **Dash:** Framework web para a construção da interface do dashboard.
